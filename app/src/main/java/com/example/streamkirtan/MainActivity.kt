package com.example.streamkirtan
...
class MainActivity : AppCompatActivity() {
    ...
    fun loadSounds() {
        soundMap.put(SOUND1,
            soundPool.load(assets.openFd("flash_beep.mp3"), 1))
        soundFile1 = SoundFile(soundMap[SOUND1]!!)
        soundMap.put(SOUND2,
            soundPool.load(assets.openFd("giraffe_energy.mp3"), 1))
        soundFile2 = SoundFile(soundMap[SOUND2]!!)
        soundMap.put(SOUND3,
            soundPool.load(assets.openFd("jungle_loop.mp3"), 1))
        soundFile3 = SoundFile(soundMap[SOUND3]!!)
        soundMap.put(SOUND4,
            soundPool.load(assets.openFd("monkey_chirp.mp3"), 1))
